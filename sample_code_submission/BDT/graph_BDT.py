...
# Charger les données
data = np.loadtxt(
    "C:/Users/julie/Documents/CS/Cours/Black Swans/EI/Higgs_collaboration_A/sample_code_submission/BDT/data_simulations.txt",
    delimiter=",",
)
...
def courbe_significance():
    ...
    unique_n_estimators = unique_n_estimators[
        :-1
    ]  # on eclu la dernière valeur de n_estimators (pas assez de simulations faites pour obtenir une moyenne significative)
