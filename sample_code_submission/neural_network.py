...
class NeuralNetwork:
    ...
    def fit(self, train_data, y_train, weights_train=None):
        ...
        self.model.fit(X_train, y_train, sample_weight=weights_train, epochs= self.epochs, batch_size = self.batchsize, verbose=2)
    ...
    def significance_2(self, test_labels=None, test_weights=None):
